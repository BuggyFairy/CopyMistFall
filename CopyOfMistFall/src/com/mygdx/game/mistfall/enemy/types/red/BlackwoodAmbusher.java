...
public class BlackwoodAmbusher extends Enemy {

	public BlackwoodAmbusher(int ID, GameController gc)
	{
		// General
		setEnemyID(ID);
		setName("Blackwood Ambusher");
		...
		// Abilities
		getAbilities().add(new EnemyAbility(EnemyAbilityType.AMBUSH,EnemyAbilityArea.HERO));
	}
