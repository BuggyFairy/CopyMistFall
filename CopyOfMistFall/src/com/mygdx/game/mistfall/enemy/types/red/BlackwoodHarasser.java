...
public class BlackwoodHarasser extends Enemy {

	public BlackwoodHarasser(int ID, GameController gc)
	{
		// General
		setEnemyID(ID);
		setName("Blackwood Harasser");
		...
		appendEnemyKeyword(EnemyKeyword.THIEF);
		// Vulnerabilities
		...
		// Abilities
		getAbilities().add(new EnemyAbility(EnemyAbilityType.SKULDUGGERY,EnemyAbilityArea.HERO));
	}
